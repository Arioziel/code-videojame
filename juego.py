...
def mostras_pantalla_ganadora():
    pantalla_ganadora = transform.scale(image.load(win_image_path), (800, 600))
    screen.blit(pantalla_ganadora, (0, 0))
    pygame.display.flip()
    pygame.time.wait(3000)
...
car_image_path = "pacman.jpg"
enemies_image_path = "fantas.png"
loss_image_path = "perdida.jpg"
win_image_path = "ganar.png"
...
enemigo2 = Enemigo("rojito.png", 400, 300, 300, 400, movimiento='vertical')
